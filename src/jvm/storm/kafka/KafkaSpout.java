...
public class KafkaSpout extends BaseRichSpout {
    ...
    public void open(Map conf, final TopologyContext context, final SpoutOutputCollector collector) {
        ...
        this.failMap=new LRUMap<Long,Integer>(100000);
    ...
    public void fail(Object msgId) {
        KafkaMessageId id = (KafkaMessageId) msgId;
        PartitionManager m = _coordinator.getManager(id.partition);
        if(this.failMap.containsKey(id.offset)){
        	int failNum=this.failMap.get(id.offset)+1;
        	this.failMap.put(id.offset, failNum);
        }else{
        	this.failMap.put(id.offset, 1);
        }
        if(this.failMap.get(id.offset)>_spoutConfig.retryTimes){
        	if (m != null) {
        		m.ack(id.offset);
            }
        	return;
